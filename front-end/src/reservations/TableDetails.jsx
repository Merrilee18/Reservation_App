             ...
             {tables.map((table, index) => {
              return (
                ...
                <div key={index}>
                  ...
                  <li>
                    {(`${table.reservation_id}` !== "null") ? <button onClick={handleClear} className="btn btn-danger">Clear Table</button> : <button value={table.table_id} onClick={submitHandler} className="btn btn-info">Seat Table</button>}
                  </li>
                  <hr />
                </div> : <></>}
                </div>
...
// function AvailableTableDetails({ tables }) {
...
//                   <li>Reservation_Id: {table.reservation_id}</li>
//                   <li>
//                     {(`${table.reservation_id}` !== "null") ? <button onClick={handleClear} className="btn btn-warning">Clear Table</button> : <button onClick={handleSubmit} className="btn btn-info">Seat Table</button>}
//                   </li>
//                   <hr />
//                 </div>
//               );
